    ...
    return (
        <section id="about" className="pt-10 pb-24">
            ...
            <div className="md:flex md:justify-between md:gap-16 mt-32">
                ...
                >
                    <p className="font-playfair font-semibold text-4xl text-red mb-5">
                        ABOUT <span className="text-white">ME</span>
                    </p>
                    <LineGradient width="w-1/3" />
                    <p className="mt-10 mb-7">Hello! My name is Ignacio and I enjoy creating and designing webs.
                    I'm motivated by the challenge of exploring innovative solutions for each project.</p>
                </motion.div>
